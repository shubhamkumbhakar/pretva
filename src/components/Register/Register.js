        ...
        <div>
            ...
            <div id="registercard">
                ...
                <div class="input-icon">
                  <select class="form-control register-form" id="yearselect" style={{width: "15.9em", fontColor:"grey", height: "2.4em", marginBottom:" 15px", paddingLeft:"18px", fontStyle:"italic"}}>
